...
Este repositorio no incluye un archivo de licencia por defecto. Si quieres usar una licencia abierta, añade un `LICENSE` (por ejemplo MIT) y actualiza este apartado.

---

Si quieres, puedo:

- Añadir un archivo `LICENSE` (MIT/Apache/BSD) y actualizar el README con la licencia concreta.
- Generar un pequeño script PowerShell más robusto para compilar todo en un paso.
- Crear instrucciones específicas para ejecutar cada demo (Sorting, Grafos, DP) por separado.
